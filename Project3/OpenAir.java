...
public class OpenAir extends Venue {
    ...
    public OpenAir(String name, int pctUnavailableSeat, int pctVIP, int pctGold, int pctSilver, int pctBronze, int pctGeneral, int pctReserved, int capacity) {
